...
INSERT INTO channel_info VALUES(1,'постщитность','/uploads/channel_avatar_-1002343587948.jpg','2026-02-09 14:13:04');
CREATE TABLE users
                 (id INTEGER PRIMARY KEY SERIAL,
                  ...
                  photo_url TEXT,
                  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
INSERT INTO users VALUES(1,6176398479,'Roman_Babko','Роман','Бабко','','2026-02-10 10:17:58');
INSERT INTO users VALUES(8,1414996308,'IncredibleDreamer','Спокойствие','','/uploads/user_avatar_1414996308.jpg','2026-02-10 13:13:30');
...
INSERT INTO sqlite_sequence VALUES('reactions',17);
INSERT INTO sqlite_sequence VALUES('users',34);
